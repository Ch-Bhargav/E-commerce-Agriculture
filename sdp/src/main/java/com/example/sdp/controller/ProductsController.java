...
public class ProductsController {
    ...
    @GetMapping("/fruits")
    public String getFruitsProducts(Model model) {
        // Fetch the list of products with the category "vegetables" from the database
